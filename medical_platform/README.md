# TORISCAN - Detaylı Proje Dokümantasyonu
...
```
medical_platform/                     # Ana proje klasörü
│
...
│   └── update_schema.sql             # (Deprecated) Artık kullanılmıyor
│
...
└── 📄 ADMIN_GUIDE.md                  # Admin kullanım kılavuzu
```
...
class Config:
    ...
    # Veritabanı
    DB_SERVER = 'Bereket\\SQLEXPRESS02'
